...
pub fn build_level1(asset_server: &AssetServer) -> LevelInfo {
  let outer = sdfu::Box::new(Vec2::new(3000., 50000.));
  let inner = sdfu::Box::new(Vec2::new(2000., 49000.));
  ...
  let finish_bounds = sdfu::Box::new(Vec2::new(3000., 1000.)).translate(Vec2::new(0.0, 49000.));
  ...
  let lvl = LevelInfo {
    ...
    finish_bounds_sdf: Some((fs, Vec2::new(0.0, 49000.))),
    bounds_sdf: Some(s),
    name: "Level 1".to_owned(),
    next_level: None,
    starting_point: Vec2::new(0.0, -49000.),
